...
public class DynamicDataSourceRegister implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata annotationMetadata, BeanDefinitionRegistry beanDefinitionRegistry) {
        ...
        defauleDataSourceProperties = binder.bind("spring.datasource.mysql", Map.class).get();
        // 获取数据源类型
//        String typeStr = evn.getProperty("spring.datasource.mysql.type");
        // 获取数据源类型
        Class<? extends DataSource> clazz = getDataSourceType("com.zaxxer.hikari.HikariDataSource");
        // 绑定默认数据源参数 也就是主数据源
        DataSource consumerDatasource, defaultDatasource = bind(clazz, defauleDataSourceProperties);
        DynamicDataSourceContextHolder.dataSourceIds.add("HikariPool-1");
...
//        }
        ...
        beanDefinitionRegistry.registerBeanDefinition("mysqlDataSource", define);
